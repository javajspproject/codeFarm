...
<footer class="footer">
    <div class="wrapper">
      <div class="footer_top menu_list_cover">
        ...
        <div class="menu_list ">
          <div class="list_title open">인프런 <span class="is-mobile list_caret"><i class="far fa-angle-up"></i><i class="far fa-angle-down"></i></span></div>
          <div class="menu_sublist" style="max-height: 118px;">
            <a href="/notices" class="list_link">공지사항</a><a href="/inflearn" class="list_link">인프런 소개</a><a href="/pages" class="list_link">인프런 이야기</a><a href="/pages/with-us" class="list_link">채용 안내</a>
          </div>
        </div>
        <div class="menu_list ">
          <div class="list_title open">고객센터 <span class="is-mobile list_caret"><i class="far fa-angle-up"></i><i class="far fa-angle-down"></i></span></div>
          <div class="menu_sublist" style="max-height: 118px;">
        ...
        <div class="menu_list ">
          <div class="list_title open">신청하기 <span class="is-mobile list_caret"><i class="far fa-angle-up"></i><i class="far fa-angle-down"></i></span></div>
          <div class="menu_sublist" style="max-height: 91px;">
        ...
        <div class="menu_list is-hidden-mobile">
          ...
          <div class="menu_sublist">
            <a href="/courses/it-programming" class="list_link">IT 프로그래밍</a><a href="/courses/creative" class="list_link">크리에이티브</a><a href="/courses/business" class="list_link">업무스킬</a>
          </div>
        </div>
        <div class="menu_list is-hidden-mobile">
      ...
      <div class="footer_bottom">
        <div class="footer_bottom_left footer_info">
          ...
          <div class="footer_info_bottom">
            ...
            <div class="info-dropdown" "="" style="max-height: 36px;">
              <span class="is-hidden-mobile">(주)인프랩 |</span>
              <span>대표자 : 이형주 |</span> <span>사업자번호 : 499-81-00612 |</span><br class="is-mobile">
              <span>개인정보보호책임자 : 구자유 |</span> <span>통신판매업 : 2018-성남분당B-0062</span><br class="is-hidden-mobile">
              <span>주소 : 성남시 분당구 삼평동 판교역로 240 삼환하이팩스 A동 208-1호 ㅣ</span> 이메일: info@inflearn.com
            </div>
